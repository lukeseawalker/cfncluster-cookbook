...
#   os: the os to build (supported values: all|centos6|centos7|alinux|ubuntu1604|ubuntu1804|sles12)
...
check_options() {
    ...
    available_os="centos6 centos7 alinux ubuntu1604 ubuntu1804 sles12"
    cwd="$(dirname $0)"
    tmp_dir=$(mktemp -d)
...
do_command() {
    ...
    case ${_os} in
      all)
        ...
        ;;
      centos6|centos7|alinux|ubuntu1604|ubuntu1804|sles12)
